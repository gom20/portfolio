...
export default function AboutOverlay({ isActive }: AboutContentProps) {
  return (
    ...
    >
      <div
        className="max-w-4xl px-8 text-white overflow-y-auto"
        style={{
          paddingLeft: "65px",
          paddingRight: "65px",
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-white pl-4">
                <h3 className="text-xl font-medium">Senior Developer</h3>
                                 <p className="text-sm text-gray-300">Tech Company • 2022 - Present</p>
               </div>
               <div className="border-l-4 border-white pl-4">
                 <h3 className="text-xl font-medium">Full-Stack Developer</h3>
                 <p className="text-sm text-gray-300">Startup • 2020 - 2022</p>
               </div>
               <div className="border-l-4 border-white pl-4">
                 <h3 className="text-xl font-medium">Frontend Developer</h3>
                 <p className="text-sm text-gray-300">Agency • 2018 - 2020</p>
              </div>
            </div>
          </div>
        </div>
