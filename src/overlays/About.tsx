        ...
        <div>
          <div className="space-y-8">
            ...
            <p
              ...
              style={{ color: 'rgb(209 213 219 / var(--tw-text-opacity, 1))' }}
            >
              지난 10년간 프론트엔드와 백엔드를 아우르며 다양한 업무를
              경험했습니다. 여러 개발 환경과 팀 문화를 경험하며 폭넓은 시야와
              유연한 문제 해결 능력을 갖추게 되었습니다. 복잡한 요구사항도
              차분히 분석하고 단계별로 해결하며, 난관에 부딪혔을 때는 다양한
              관점에서 접근해 최적의 해결책을 찾아냅니다.
            </p>
            ...
            <p
              ...
              style={{ color: 'rgb(209 213 219 / var(--tw-text-opacity, 1))' }}
            >
              개발을 할 때는 주석 없이도 이해되는 명확한 코드 작성에 중점을 두고
              있습니다. 가독성 높은 함수와 변수 네이밍은 물론, 확장성과
              유지보수성을 고려한 구조 설계에 깊이 고민하여 기술적 완성도와
              사용자 경험을 모두 만족시키는 결과물을 추구합니다.
            </p>
