...
export default function LabsOverlay({ isActive, onClose }: LabsOverlayProps) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-4">
                      <h3
                        className="text-lg md:text-xl font-normal text-gray-200"
                    ...
                    {/* 더보기 화살표 */}
                    <a
                      href="https://github.com/gom20/resume"
                      target="_blank"
                ...
                <p className="text-sm text-gray-300 mb-4 leading-relaxed">
                  React와 TypeScript를 기반으로 제작한 개인 포트폴리오
                  웹사이트입니다. Vite를 사용하여 빠르고 효율적인 개발 환경을
                  구축했으며, Tailwind CSS로 모던하고 반응형 UI를 구현했습니다.
                  연도별 경력, 기술 스택, 프로젝트 경험을 체계적으로 정리하여
                  보여주는 화면 전환과 인터랙티브 오버레이 방식을 함께 적용해
                  부드러운 사용자 경험을 구현했습니다. 개발 과정 전반을 AI를
                  활용한 바이브 코딩 방식으로 진행하여, 세밀한 UI/UX 디테일과
                  복잡한 인터랙션을 구현했습니다.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-sm text-gray-300 mb-4 leading-relaxed">
                  서비스 소개와 신청 유도를 목적으로 제작한 마케팅 랜딩페이지로,
              ...
              >
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {/* 더보기 화살표 */}
                    <a
                      href="https://gomi-eight.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block"
                    >
                ...
                <p className="text-sm text-gray-300 mb-4 leading-relaxed">
                  Next.js로 제작한 정적 반응형 포트폴리오 웹 페이지로, Next.js의
                  라우팅 기능을 활용하여 화면 전환 시 전체 페이지를 새로고침하지
                  않고 부드럽게 이동할 수 있도록 구현했습니다. 모든 화면은 React
                  컴포넌트 구조로 구성되었으며, CSS 반응형 설계를 통해 PC,
                  태블릿, 모바일 등 다양한 디바이스 환경에서 최적화된 UI
                  제공하도록 구현했습니다. 최종 결과물은 Vercel을 통해
                  배포되었습니다.
                </p>
              </div>
              ...
              >
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {/* 더보기 화살표 */}
                    <a
                      href="https://github.com/gom20/mago-ui"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block"
                    >
                ...
                <p className="text-sm text-gray-300 mb-4 leading-relaxed">
                  이 프로젝트는 Spring Boot, React Native를 기반으로 개발한 등산
                  기록 및 관리 모바일 애플리케이션입니다. 사용자는 회원 가입 및
                  로그인 절차를 거쳐 서비스를 이용할 수 있습니다. 등산 기능을
                  실행하면 실시간으로 등산 진행 상황을 기록할 수 있으며, 등산
                  종료 후에는 경로와 기록이 저장됩니다. 또한 목표 산행을
                  달성하면 스탬프를 획득하는 게임화 요소가 포함되어 있습니다.
                  기록 관리 화면에서는 과거 등산 데이터를 확인할 수 있고, 계정
                  설정 메뉴에서 개인 정보 변경 및 탈퇴가 가능합니다. 이 앱은
                  React 학습을 목적으로 진행한 프로젝트로, 실제 개발 과정을 통해
                  React의 컴포넌트 구조와 상태 관리에 대해 직접 경험하고 익힐 수
                  있었습니다.
                </p>
              </div>
            </div>
